// ─────────────────────────────────────────────────────────────────────────────
// dsh-pet-deepseek-girl —— 状态气泡文案库（DeepSeek 娘 persona）
// 每种状态多句文案，按事件 seq 确定性轮换（同一事件永远同句）。
// 结构与思路参考 dsh-dafeiyu 的 status-copy.js（MIT），文案为原创。
// ─────────────────────────────────────────────────────────────────────────────
